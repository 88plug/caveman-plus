...
Pre-1.0 — the compression rules and field set may change. The plugin is part of the [caveman ecosystem](https://github.com/88plug/caveman-plus); see the parent repo for the full skill suite (`caveman`, `cavemem`, `cavekit`, `cavecrew`, `caveman-stats`, `caveman-init`).
