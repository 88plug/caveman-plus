...
const os = require('os');
const { getDefaultMode, normalizeMode, safeWriteFlag } = require('./caveman-config');
...
// Resolve canonical label for display and filtering.
const modeLabel = mode === 'mello' ? 'mello' : mode;
...
if (skillContent) {
  ...
  output =
    ...
    'Current level: **' + modeLabel + '**. Switch: `/caveman lite|full|full-plus|ultra|mello-lite|mello|mello-ultra`.\n\n' +
    '## Rules\n\n' +
