...
const rulesByMode = {
  ...
  'full-plus': [
    ...
    'Explainers: plain mechanism prose. Bug-fix/debug asks: root cause + direct fix. No extra caveat unless safety/correctness requires.',
    'Newest ask only. One default path. No extra variants unless asked.',
    'Summary/comment/note/PR asks: polished final artifact only. Match requested format and include one obvious benefit/risk reduction if it helps. Checklist asks: actionable checks. No extra caveat unless asked.',
    ...
    'Density target: "New obj ref each render. `memo` alone no help. Fix: `useMemo`; if static, move obj outside component or pass primitives."',
